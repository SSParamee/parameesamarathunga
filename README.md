...
[![Maintenance](https://img.shields.io/badge/maintained-yes-green.svg)](https://github.com/SSParamee/SSParamee.github.io/commits/main)
[![Website](https://img.shields.io/badge/website-live-D4A843)](https://ssparamee.github.io)
[![LinkedIn](https://img.shields.io/badge/connect-linkedin-0A66C2)](https://www.linkedin.com/in/paramee-samarathunga)
...
View the live **[portfolio](https://ssparamee.github.io/parameesamarathunga/)**
...
| [**DM Serif Display**](https://fonts.google.com/specimen/DM+Serif+Display) | Display / heading typeface |
| [**Inter**](https://fonts.google.com/specimen/Inter) | Body and UI typeface |
| [**JetBrains Mono**](https://fonts.google.com/specimen/JetBrains+Mono) | Labels, tags, and monospaced elements |
| **Vanilla JS** | Animations, tab switching, flip cards, scroll-spy |
 
No CSS frameworks. No JavaScript libraries. No build tools required.
...
```
ssparamee.github.io/
├── index.html          # Single-page portfolio — all content, styles, and scripts
├── assets/             # Proof screenshots for project flip cards
│   ├── profile.jpg     # Profile photo (circular, dark background recommended)
│   └── asset files
├── README.md
└── LICENSE
```
...
| Metric | Detail |
|--------|--------|
| **7+ years** | Senior experience across enterprise ERP, SaaS, open banking, and regulated industries |
| **150K+** | Monthly organic visits driven across Creately and Dipuravana |
| **75%** | AHT reduction through documentation wiki at IFS |
| **50%** | Documentation turnaround reduction via M365 Copilot AI agent |
 
---
 
## License 📄
 
This repository is licensed under the terms of the Creative Commons [LICENSE](LICENSE) file.
 
---
 
<p align="center">
  Built with precision by <a href="https://www.linkedin.com/in/paramee-samarathunga">Paramee Samarathunga</a>
</p>
